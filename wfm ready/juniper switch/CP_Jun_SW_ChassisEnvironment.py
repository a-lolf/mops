...
def CP_Jun_SW_ChassisEnvironment(input_json):  # NOTE: Function name and file name have to be EXACTLY the same!
    """
    Description:
...
# input_json = {
# "inputParameter": {
# "commandOutput": """Noc@MG-AN1-5110-BLF01> show chassis environment 
# Class Item                           Status     Measurement
# Power FPC 0 Power Supply 0           OK         28 degrees C / 82 degrees F
#       FPC 0 Power Supply 1           OK         29 degrees C / 84 degrees F
# Temp  FPC 0 Sensor TopLeft I         OK         27 degrees C / 80 degrees F
#       FPC 0 Sensor TopLeft E2        OK         30 degrees C / 86 degrees F
#       FPC 0 Sensor TopCenter E2      OK         30 degrees C / 86 degrees F
#       FPC 0 Sensor TopLeft E1        OK         31 degrees C / 87 degrees F
#       FPC 0 Sensor CPULeft I         OK         23 degrees C / 73 degrees F
#       FPC 0 Sensor CPURight I        OK         22 degrees C / 71 degrees F
#       FPC 0 Sensor CPU Die Temp      OK         39 degrees C / 102 degrees F
#       FPC 0 Sensor TopRight OCXO     OK         26 degrees C / 78 degrees F
#       FPC 0 Sensor TopRight E        OK         31 degrees C / 87 degrees F
#       FPC 0 Sensor BottomLeft E      OK         26 degrees C / 78 degrees F
#       FPC 0 Sensor TopRight I        OK         31 degrees C / 87 degrees F
#       FPC 0 Sensor TopCenter E1      OK         30 degrees C / 86 degrees F
...
#       FPC 0 Fan Tray 3 Fan 0         OK         Spinning at normal speed
#       FPC 0 Fan Tray 3 Fan 1         OK         Spinning at normal speed
# ---(more)---
                                        
#       FPC 0 Fan Tray 4 Fan 0         OK         Spinning at normal speed
#       FPC 0 Fan Tray 4 Fan 1         OK         Spinning at normal speed""",
# "autoTT" : "No",
# "details":"Yes",
# "maxAllowed" : "25",
# "status" : "SUCCESS",
...
# a = CP_Jun_SW_ChassisEnvironment(input_json)
# print(a)
