...
def CP_Jun_Router_chassisRoutingEngine(input_json):  # NOTE: Function name and file name have to be EXACTLY the same!
    """
    Description:
...
---(more)---
    ...
    Model                          RE-S-2X00x6
    Serial ID                      CANJ6844
    Start time                     2024-10-01 01:33:35 WAT
    Uptime                         95 days, 9 hours, 52 minutes, 4 seconds
...
---(more 77%)---
    ...
    Model                          RE-S-2X00x6
    Serial ID                      CARK4908
    Start time                     2024-10-01 01:12:24 WAT
    Uptime                         95 days, 10 hours, 13 minutes
    Last reboot reason             0x2000:hypervisor reboot
    Load averages:                 1 minute   5 minute  15 minute
                                       0.27       0.17       0.15",
"autoTT" : "No",
...
a = CP_Jun_Router_chassisRoutingEngine(input_json)
print(a)
