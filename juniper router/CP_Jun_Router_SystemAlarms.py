...
def CP_Jun_Router_SystemAlarms(input_json):  # NOTE: Function name and file name have to be EXACTLY the same!
    """
    Description:
    ...
    try:
        ...
        # Assigns "NOK" to autoTT if resultValue >= 1, otherwise assigns "Ok"
...
a = CP_Jun_Router_SystemAlarms(input_json)
print(a)
