...
def CP_Jun_SW_SystemUptime(input_json):  # NOTE: Function name and file name have to be EXACTLY the same!
    """
    Description:
    ...
    try:
        ...
        minUptime = input_data['inputParameter']['minUptime']
        ...
        if _match:
            _fullString = str(_match[0].strip())
...
# input_json = '''{
# "inputParameter": {
# "commandOutput": "Noc@MG-AN1-5110-BLF01> show system uptime 
# localre:
# --------------------------------------------------------------------------
# Current time: 2024-12-04 05:04:40 EAT
# Time Source:  NTP CLOCK 
# System booted: 2024-02-09 00:58:37 EAT (42w5d 04:06 ago)
# Protocols started: 2024-02-09 01:00:15 EAT (42w5d 04:04 ago)
# Last configured: 2024-11-29 14:21:46 EAT (4d 14:42 ago) by aosadmin
#  5:04AM  up 299 days,  4:06, 1 users, load averages: 1.53, 1.01, 0.82",
# "autoTT": "No",
# "details": "No",
# "minUptime": "24",
# "status": "SUCCESS",
...
# a = CP_Jun_SW_SystemUptime(input_json)
# print(a)
